...
class SuccessOneScreen extends StatelessWidget {
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Text("msg_you_place_the_order".tr,
  ...
  /// Navigates to the buyContainerScreen when the action is triggered.
  onTapContinue(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.buyContainerScreen);
  }
}
