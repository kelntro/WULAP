import '../set_a_one_screen/widgets/cartappcardlist1_item_widget.dart';
import '../set_a_one_screen/widgets/userprofilelist_item_widget.dart';
...
class SetAOneScreen extends StatelessWidget {
  SetAOneScreen({Key? key}) : super(key: key);
  ...
  TextEditingController overflowmenuController3 = TextEditingController();

  TextEditingController overflowmenuController4 = TextEditingController();
                ...
                child: SingleChildScrollView(
                    ...
                    child: Container(
                        ...
                        child: Stack(alignment: Alignment.topRight, children: [
                          ...
                          CustomImageView(
                              imagePath:
                                  ImageConstant.imgEpArrowRightBoldBlack90002,
                              height: 39.v,
                              width: 29.h,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        leading: AppbarLeadingImage(
            ...
            margin: EdgeInsets.only(left: 28.h, top: 36.v, bottom: 14.v),
            onTap: () {
    ...
    return Padding(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Cartappcardlist1ItemWidget(onTapImgOverflowMenu: () {
  ...
  /// Section Widget
  Widget _buildOverflowmenu1(BuildContext context) {
    return CustomTextFormField(
        width: 330.h,
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Text("lbl_may".tr,
                      style: CustomTextStyles.dMSansGray800))),
          _buildOverflowmenu1(context)
        ]));
  }

  /// Section Widget
  Widget _buildOverflowmenu2(BuildContext context) {
    return CustomTextFormField(
        width: 330.h,
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Text("lbl_june".tr,
                      style: CustomTextStyles.dMSansGray800))),
          _buildOverflowmenu2(context)
        ]));
  }

  /// Section Widget
  Widget _buildOverflowmenu3(BuildContext context) {
    return CustomTextFormField(
        width: 330.h,
        controller: overflowmenuController3,
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Text("lbl_july".tr,
                      style: CustomTextStyles.dMSansGray800))),
          _buildOverflowmenu3(context)
        ]));
  }

  /// Section Widget
  Widget _buildOverflowmenu4(BuildContext context) {
    return CustomTextFormField(
        width: 330.h,
        controller: overflowmenuController4,
