...
class ContactoneScreen extends StatelessWidget {
  ContactoneScreen({Key? key}) : super(key: key);
  ...
  TextEditingController addressGroupController = TextEditingController();
                    ...
                    child: Column(children: [
                      ...
                      Container(
                          ...
                          child:
                            ...
                            CustomImageView(
                                imagePath: ImageConstant.imgEllipse4664x64,
                                height: 64.adaptSize,
                                width: 64.adaptSize,
  ...
  /// Section Widget
  Widget _buildGroup296(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 25.h, top: 8.v, bottom: 4.v),
        child: CustomTextFormField(
            width: 108.h,
            controller: group296Controller,
            hintText: "lbl_09934705929".tr,
            textInputType: TextInputType.phone));
  }

  /// Section Widget
  Widget _buildGroup297(BuildContext context) {
    return Container(
  ...
  Widget _buildAddressGroup(BuildContext context) {
    return Padding(
        ...
        child: CustomTextFormField(
            width: 189.h,
            controller: addressGroupController,
  ...
  /// Section Widget
  Widget _buildAddressStack(BuildContext context) {
    return SizedBox(
        height: 52.v,
        width: 350.h,
        child: Stack(
            alignment: Alignment.centerRight,
            children: [_buildAddress1(context), _buildAddressGroup(context)]));
  }
