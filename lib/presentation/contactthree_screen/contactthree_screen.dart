...
class ContactthreeScreen extends StatelessWidget {
  ContactthreeScreen({Key? key}) : super(key: key);
  ...
  TextEditingController group326Controller = TextEditingController();
                    ...
                    child: Column(children: [
                      ...
                      Container(
                          ...
                          child:
                            ...
                            CustomImageView(
                                imagePath: ImageConstant.imgEllipse5959x60,
                                height: 59.v,
                                width: 60.h,
  ...
  /// Section Widget
  Widget _buildGroup324(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 25.h, top: 8.v, bottom: 4.v),
        child: CustomTextFormField(
            width: 108.h,
            controller: group324Controller,
            hintText: "lbl_09934705929".tr,
            textInputType: TextInputType.phone));
  }

  /// Section Widget
  Widget _buildGroup325(BuildContext context) {
    return Container(
  ...
  /// Section Widget
  Widget _buildGroup326(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(right: 7.h),
        child: CustomTextFormField(
            width: 189.h,
            controller: group326Controller,
  ...
  Widget _buildAddress2(BuildContext context) {
    return SizedBox(
        ...
        child: Stack(
            alignment: Alignment.centerRight,
            children: [_buildAddress1(context), _buildGroup326(context)]));
  }
        ...
        child: Row(children: [
          Padding(
              ...
              child: Text("lbl_facebook".tr,
                  style: CustomTextStyles.bodyLargeDMSansBluegray800_1)),
          Padding(
              padding: EdgeInsets.only(left: 38.h, top: 2.v),
              child: Text("lbl_jason_wang".tr,
                  style: CustomTextStyles.bodyLargeDMSansBlack90002))
        ]));
  }
